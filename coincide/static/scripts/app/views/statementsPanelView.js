define([
	"ember",
	"text!templates/statementsPanelTemplate.html",
...
], function(Ember, statementsPanelTemplate, setxy, create, showChar, hideChar, openrepeat, closerepeat, openfor, closefor, 
	openwhile, closewhile, move, changeCostume, changeBackground, booleanExp, math, assignVariable, openIf, elsev, closeIf, 
	booleanOp, booleanNot, createClockHands, rotateClockHands, recycle, printVariable ) {
